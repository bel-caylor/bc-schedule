...
function render_exclude_dates_form() {
    ?>
    <div class="wrap bcs">
        <h1 class="!bcs-mb-4">Add Excluded Date for User</h1>
        ...
        <div x-data="form()" x-init="init()">
            <form method="post" action="admin-post.php">
                ...
                <div class="bcs-flex bcs-items-center">
                    ...
                    <label for="exclude_date" class="bcs-pl-4 bcs-pr-1">Add Exclude Date:</label>
                ...
                <h2 x-show="excludedDates.length > 0" class="bcs-pt-4 bcs-pb-1 bcs-font-bold" x-cloak>Exclude Dates</h2>
                <template x-for="date in excludedDates">
                    <div class="pbcs-y-2">
                        <span x-text="date"></span>
                        <button class="dashicons dashicons-remove bcs-text-blue-400" @click.prevent="removeDate()"></button>
                    </div>
                </template>
                <input name="dates" type="hidden" x-model="formattedExcludedDates()">
                <div class="bcs-pt-10" x-cloak>
